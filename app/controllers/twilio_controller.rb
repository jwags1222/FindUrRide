...
class TwilioController < ApplicationController
  ...
  def text
    ...
    @twilio_client.account.messages.create(:from => "+1#{twilio_phone_number}", :to => '4124273378', :body => "\nAnother lead from LeadFeed!  \n #{from_number} texted us about the #{car_requested.last.year},  #{car_requested.last.make} #{car_requested.last.model}. You will receive an email update with all of your leads at the end of the day.  Thank you for your business")
